...
# sh, awk, grep, sed, date, mkdir, sleep, tail, wc, cut, mkfifo, tee.
set -eu
...
CSS
    ...
    printf '<h1>Snowflake Proxy Stats</h1><div class="meta">Generated %s &middot; Snowflake Dashboard powered by ruxal</div>\n' "$(esc "$generated_at")"
